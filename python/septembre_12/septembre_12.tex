...
\begin{frame}[fragile]{Exercice}
\begin{enumerate}
 \item Créer une liste contenant 0, 1, 2, 3, 4, 5
 \item Mettre cette liste renversée dans une variable
\end{enumerate}\pause
...
\begin{frame}[fragile]{Exercice}
\begin{enumerate}
 \item Créer un tuple contenant 'voiture', 'camion', 'avion', 'pied'
 \item En utilisant une boucle et une condition, afficher les mots contenant la lettre a
\end{enumerate}
\begin{lstlisting}
camion
avion
