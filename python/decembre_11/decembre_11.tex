...
Structure ordonnée de taille dynamique contenant une collection d'objets de types différents
\begin{lstlisting}
>>> x = []
>>> type(x)
<type 'list'>
...
Comparable aux liste à la différence que les tuples ne sont pas modifiables
